...
public class ProductController {
    ...
    public void getAllByVendorId(ServerRequest request, ServerResponse response) {
        final List<ProductDto> products = productService.findAllByVendorId(Long.valueOf(request.getRequestParameter("id")), request.getToken());
    ...
    public void getById(ServerRequest request, ServerResponse response) {
        final ProductDto product = productService.findById(Long.valueOf(request.getRequestParameter("id")), request.getToken());
    ...
    public void deleteById(ServerRequest request, ServerResponse response) throws IOException {
        productService.deleteById(Long.valueOf(request.getRequestParameter("id")), request.getToken());
